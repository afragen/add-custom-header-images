...
# main config
PLUGINSLUG="rotate-custom-headers"
CURRENTDIR=`pwd`
MAINFILE="rotate-custom-headers.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/rotate-custom-headers" # Remote SVN repo on wordpress.org, with no trailing slash

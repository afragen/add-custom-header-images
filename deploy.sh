...
# main config
PLUGINSLUG="add-custom-header-images"
CURRENTDIR=`pwd`
MAINFILE="add-custom-header-images.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/add-custom-header-images" # Remote SVN repo on wordpress.org, with no trailing slash
